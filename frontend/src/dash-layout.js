(function () {
  ...
  if (REDIRECTS[curFile]) {
    window.location.replace("./" + REDIRECTS[curFile]);
    return;
  }
    ...
    return `
      <aside class="dash-sidebar" id="dashSidebar">
        <div class="dash-sidebar__inner sidebar-card">
          <a class="dash-sidebar__brand sidebar-brand" href="./index.html">
            <img class="brand-logo" src="./src/logo.svg" alt="" width="48" height="48" />
            <div>
